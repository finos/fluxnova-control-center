...
test.describe('Incidents List - Reset View', () => {
  /*
  ...
  */
  ...
  test.beforeEach(async ({ page }) => {
    await page.goto(`./${BasePage.TENANT}/incidents`);
  ...
  test('should change column width', async ({ page }) => {
    ...
    await changeColumnWidthVerifyAndResetView('Incident Message', 'Create Time', page, resetViewButton);
  });
  ...
  test('should change column order', async ({ page }) => {
    ...
    await changeColumnOrderVerifyAndResetView('Incident Message', 'Create Time', page, resetViewButton);
  });
  ...
  test('should change filtering', async ({ page }) => {
    ...
    await changeFilterVerifyAndResetView('processInstanceId', page, resetViewButton);
  });
  ...
  test('should change sorting', async ({ page }) => {
    ...
    await changeSortingVerifyAndResetView('Status', 'Create Time', false, page, resetViewButton);
  });
});
