...
test.describe('Batches List - Reset View', () => {
  /*
  ...
  */
  ...
  test.beforeEach(async ({ page }) => {
    await page.goto(`./${BasePage.TENANT}/batches?sorting=%5B%7B"colId":"startTime","sort":"desc"%7D%5D`);
  ...
  test('should change column width', async ({ page }) => {
    ...
    await changeColumnWidthVerifyAndResetView('Create User', 'Start Time', page, resetViewButton);
  });
  ...
  test('should change column order', async ({ page }) => {
    ...
    await changeColumnOrderVerifyAndResetView('Create User', 'Start Time', page, resetViewButton);
  });
  ...
  test('should change filtering', async ({ page }) => {
    ...
    await changeFilterVerifyAndResetView('createUserId', page, resetViewButton);
  });
  ...
  test('should change sorting', async ({ page }) => {
    ...
    await changeSortingVerifyAndResetView('Batch ID', 'Start Time', false, page, resetViewButton);
  });
});
